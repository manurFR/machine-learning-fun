...
def logistic_log_likelihood(x, y, beta):
    """by the law of probabilities, the likelihood of a set of data is the product of the likelihoods of each data ;
       and since log(a*b) = log(a) + log(b), the log(likelihood) of the set is the sum of the log(likelihood)'s of each data"""
